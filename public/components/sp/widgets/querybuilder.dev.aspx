...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div class="spexp">
        <div data-widget="querybuilder"></div>
    </div>
    <script type="text/javascript" src="https://spexplorerjsdev.azurewebsites.net/components/sp/widgets/querybuilder.dev.js"></script>
</asp:Content>
