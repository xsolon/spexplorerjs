...
/******/ 	return __webpack_require__(__webpack_require__.s = "./customaction.dal.js");
/******/ })
/************************************************************************/
/******/ ({
...
__webpack_require__(/*! ../api/sp.base.js */ "../api/sp.base.js");
...
(function (ns, $) {
	...
	var customactions = {
		dal: CASPDAL,
		version: "0.1.2",
		getActions: function getActions(container) {
			var actions = container.get_userCustomActions();
		...
		addCustomAction: function addCustomAction(container, location, ext, sequence, perms, title, src) {
			var actions = container.get_userCustomActions();
