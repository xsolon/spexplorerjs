...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div class="spexp">
        <div data-widget="spFileReport"></div>
    </div>
    <script type="text/javascript" src="https://spexplorerjsdev.azurewebsites.net/components/sp/widgets/spFileReport.dev.js"></script>
</asp:Content>
