...
/******/ 	return __webpack_require__(__webpack_require__.s = "./sp.list.js");
/******/ })
/************************************************************************/
/******/ ({
...
// v 0.0.11: 2018-09-07  - ensureFields check if field exists
					...
					ns.modules.funcs.processAsQueue(fields, function (field) {
						return $.Deferred(function (fieldDfd) {
							getMarkup(field).done(function (xml) {
								...
								var internalName = $(XML).find("Field").attr("DisplayName") || $(XML).find("Field").attr("InternalName");
								var spField = spFieldMap[internalName];
								if (spField) {
									ctrace.log(internalName + " found");
								} else {
