...
var script = document.createElement("script"), t = new Date();
script.src = "https://spexplorerjs.azurewebsites.net/components/loader/spwizard.js?i=" + t.getMilliseconds(); document.getElementsByTagName("body")[0].appendChild(script); void (0);
