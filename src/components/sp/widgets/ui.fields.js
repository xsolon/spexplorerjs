...
(function (ns, $) {
  ...
  var fieldUi = function (el/*, opts*/) {// constructor
    ...
    me.bindToList = function (splist) {
      ns.modules.listapi.getFields(splist).done(function (fields) {
        bindFieldSelect(select, fields, false);
      });
    };
    ...
    $("[data-widget=\"xSPTreeLight\"]", $el).xSPTreeLight().on("listchange", function (e, list) {
      me.bindToList(list);
    });
    return me;
  };
